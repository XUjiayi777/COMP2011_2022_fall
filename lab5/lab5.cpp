...
{
    if (((move == 'i') && (row_position == 0)) || ((move == 'k') && (row_position == HEIGHT - 1)) ||
        ((move == 'j') && (col_position == 0)) || ((move == 'l') && (col_position == WIDTH - 1)))
    {
        return false;
    }
    if ((move == 'i') || (move == 'j') || (move == 'k') || (move == 'l'))
    {
        ...
        else if (canvas[row_position][col_position] == 'X')
        {
            canvas[row_position][col_position] = 'x';
        }
    }
    if (move == 'j')
    {
        if (canvas[row_position][col_position - 1] == '.')
        {
            canvas[row_position][col_position - 1] = '#';
        }
        else if (canvas[row_position][col_position - 1] == 'x')
        {
    ...
    {
        if (canvas[row_position - 1][col_position] == '.')
        {
            canvas[row_position - 1][col_position] = '#';
        }
        else if (canvas[row_position - 1][col_position] == 'x')
        {
